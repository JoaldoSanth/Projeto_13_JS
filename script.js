var margem_aleatorias = ["-5px", "1px", "5px", "10px", "7px"];
var cores_aleatorias = ["#c2ff3d","#ff3de8","#3dc2ff","#04e022","#bc83e6","#ebb328"];
var inclinacao_aleatoria = ["rotate(3deg)", "rotate(1deg)", "rotate(-1deg)", "rotate(-3deg)", "rotate(-5deg)", "rotate(-8deg)"];
var index = 0;
